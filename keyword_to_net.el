...
(defun  get (socket)
  (send socket (concat (lineconcat (list (storage GET /?debug_info=as&debug_id=123456&wwsy=no&rows=60&start=0&wt=json&q=玉米油&fl=vendor_Name,partnumber,brand_Name,auxdescription,three_groupName,three_groupExtName,author,isbn,unit_searchable_attr,title,two_groupName,threeGroupIds,short_brand_Id HTTP/1.0) 
